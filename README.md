...
Приложение для магазина по продаже канцелярских товаров.
...
1. **Клонирование репозитория**
    + Зайти на репозиторий на Github [Пиши-читай](https://github.com/lisaromanova/OfficeProductUP) и скопировать ссылку из адресной строки.
